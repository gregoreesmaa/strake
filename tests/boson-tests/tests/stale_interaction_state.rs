...
//!
//! Regression test for https://github.com/DioxusLabs/boson/issues/545: the
...
use boson_dom::{Document, DocumentConfig};
use boson_html::{HtmlDocument, HtmlProvider};
use boson_traits::{
    events::{
        BosonPointerEvent, BosonPointerId, MouseEventButton, MouseEventButtons, Point,
...
fn pointer_event(x: f32, y: f32, buttons: MouseEventButtons) -> BosonPointerEvent {
    BosonPointerEvent {
...
fn hover_pseudo_region(doc: &mut HtmlDocument) -> boson_traits::node_id::NodeId {
