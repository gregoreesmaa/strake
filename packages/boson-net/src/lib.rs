//! Networking (HTTP, filesystem, Data URIs) for Boson
//!
//! Provides an implementation of the [`boson_traits::net::NetProvider`] trait.

use boson_traits::net::{AbortSignal, Body, Bytes, NetHandler, NetProvider, NetWaker, Request};
...
fn get_cache_path() -> std::path::PathBuf {
    ...
    let path = {
        ...
        ProjectDirs::from("com", "DioxusLabs", "Boson")
        ...
        match body {
            ...
            Body::Form(form_data) => match content_type {
                ...
                Some("multipart/form-data") => {
                    use boson_traits::net::Entry;
                    use boson_traits::net::EntryValue;
