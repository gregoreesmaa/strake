...
impl<'doc, Handler: EventHandler> EventDriver<'doc, Handler> {
    ...
    pub fn handle_pointer_move(&mut self, event: &StrakePointerEvent) -> Option<NodeId> {
    ...
    pub fn handle_ui_event(&mut self, event: UiEvent) {
        ...
        match &event {
            ...
            UiEvent::PointerUp(event) => {
                ...
                if event.is_primary && matches!(event.id, StrakePointerId::Finger(_)) {
        ...
        match event {
            ...
            UiEvent::PointerCancel(data) => {
                ...
                self.handle_pointer_event(
                    ...
                    None::<fn(StrakePointerEvent) -> DomEventData>,
    ...
    fn handle_pointer_event(
        &mut self,
        target: NodeId,
        data: StrakePointerEvent,
        make_ptr_data: impl FnOnce(StrakePointerEvent) -> DomEventData,
        make_mouse_data: Option<impl FnOnce(StrakePointerEvent) -> DomEventData>,
        make_touch_data: impl FnOnce(StrakePointerEvent) -> DomEventData,
    ) {
