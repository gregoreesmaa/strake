...
/// be driven by [`strake-shell`](https://docs.rs/strake-shell)
...
impl BaseDocument {
    ...
    pub(crate) fn set_keyboard_modality(&self, armed: bool) {
        self.root_node().set_keyboard_modality(armed);
    }
...
mod hover_state_tests {
    ...
    /// parser lives in strake-html, which would be a circular dev-dependency).
...
mod font_face_override_tests {
    ...
    /// downstream HTML parser lives in `strake-html` (would be a circular
    ...
    fn font_face_overrides_alias_family_name() {
        ...
        let response = ResourceLoadResponse {
            ...
            result: Ok(Resource::Font(
                strake_traits::net::Bytes::from_static(crate::BULLET_FONT),
                FontFaceOverrides {
