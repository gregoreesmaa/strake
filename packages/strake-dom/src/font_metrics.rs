...
#[derive(Clone)]
pub(crate) struct StrakeFontMetricsProvider {
    pub(crate) font_ctx: Arc<Mutex<FontContext>>,
}

impl core::fmt::Debug for StrakeFontMetricsProvider {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(f, "StrakeFontMetricsProvider")
    }
}

impl FontMetricsProvider for StrakeFontMetricsProvider {
