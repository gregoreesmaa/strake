...
#[repr(u8)]
pub enum UiEvent {
    PointerMove(BosonPointerEvent),
    PointerUp(BosonPointerEvent),
    PointerDown(BosonPointerEvent),
    PointerCancel(BosonPointerEvent),
    Wheel(BosonWheelEvent),
    KeyUp(BosonKeyEvent),
    KeyDown(BosonKeyEvent),
    Ime(BosonImeEvent),
...
pub enum DomEventData {
    ...
    PointerUp(BosonPointerEvent),
    PointerCancel(BosonPointerEvent),
    PointerEnter(BosonPointerEvent),
    PointerLeave(BosonPointerEvent),
    PointerOver(BosonPointerEvent),
    PointerOut(BosonPointerEvent),

    MouseMove(BosonPointerEvent),
    MouseDown(BosonPointerEvent),
    MouseUp(BosonPointerEvent),
    MouseEnter(BosonPointerEvent),
    MouseLeave(BosonPointerEvent),
    MouseOver(BosonPointerEvent),
    MouseOut(BosonPointerEvent),

    TouchStart(BosonPointerEvent),
    TouchMove(BosonPointerEvent),
    TouchEnd(BosonPointerEvent),
    TouchCancel(BosonPointerEvent),

    Scroll(BosonScrollEvent),
    Wheel(BosonWheelEvent),

    Click(BosonPointerEvent),
    ContextMenu(BosonPointerEvent),
    DoubleClick(BosonPointerEvent),

    KeyPress(BosonKeyEvent),
    KeyDown(BosonKeyEvent),
    KeyUp(BosonKeyEvent),
    Input(BosonInputEvent),
    Ime(BosonImeEvent),

    Focus(BosonFocusEvent),
    Blur(BosonFocusEvent),
    FocusIn(BosonFocusEvent),
    FocusOut(BosonFocusEvent),
...
#[derive(Clone, Debug)]
pub struct BosonPointerEvent {
    pub id: BosonPointerId,
    pub is_primary: bool,
    ...
    pub active_pointers: Arc<AtomicRefCell<Vec<BosonPointerEvent>>>,
}

impl BosonPointerEvent {
    #[inline(always)]
    pub fn is_mouse(&self) -> bool {
        matches!(self.id, BosonPointerId::Mouse)
    }
    #[inline(always)]
    pub fn is_pen(&self) -> bool {
        matches!(self.id, BosonPointerId::Pen)
    }
    #[inline(always)]
    pub fn is_finger(&self) -> bool {
        matches!(self.id, BosonPointerId::Finger(_))
    }
...
#[derive(Clone, Debug)]
pub enum BosonWheelDelta {
    Lines(f64, f64),
    Pixels(f64, f64),
}

#[derive(Clone, Debug)]
pub struct BosonWheelEvent {
    pub delta: BosonWheelDelta,
    pub coords: PointerCoords,
    pub buttons: MouseEventButtons,
    pub mods: Modifiers,
    pub element: Point<f32>,
...
#[derive(Clone, Debug)]
pub struct BosonInputEvent {
    pub value: String,
}

#[derive(Clone, Debug)]
pub struct BosonFocusEvent;

/// Copy of Winit IME event to avoid lower-level Boson crates depending on winit
#[derive(Debug, Clone, PartialEq, Eq, Hash)]
pub enum BosonImeEvent {
