//! Tests for the JavaScript DOM APIs exposed by boson-vibey-script

use boson_dom::{Document, DocumentConfig};
use boson_traits::events::DomEvent;
...
fn input_selection_offsets() {
    let mut doc = ScriptDocument::from_html(
        ...
        "#,
        DocumentConfig {
            viewport: Some(boson_traits::shell::Viewport::new(
                800,
                600,
                1.0,
                boson_traits::shell::ColorScheme::Light,
            )),
            ..Default::default()
        },
    );
