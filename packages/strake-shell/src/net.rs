...
// pub struct StrakeShellNetWaker(StrakeShellProxy);

// impl StrakeShellNetWaker {
//     pub fn new(proxy: StrakeShellProxy) -> Self {
//         Self(proxy)
//     }

//     pub fn shared(proxy: StrakeShellProxy) -> Arc<dyn NetWaker> {
//         Arc::new(Self(proxy))
//     }
// }
// impl NetWaker for StrakeShellNetWaker {
//     fn wake(&self, doc_id: usize) {
//         self.0.send_event(StrakeShellEvent::RequestRedraw { doc_id })
//     }
// }

#[cfg(feature = "data-uri")]
mod data_uri_net_provider {
    //! Data-URI only networking for Strake
    //!
