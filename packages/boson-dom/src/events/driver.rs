...
use boson_traits::events::{
    BosonPointerEvent, BosonPointerId, DomEvent, DomEventData, EventState, Point, PointerCoords,
    UiEvent,
};
...
impl<'doc, Handler: EventHandler> EventDriver<'doc, Handler> {
    ...
    pub fn handle_pointer_move(&mut self, event: &BosonPointerEvent) -> Option<NodeId> {
    ...
    pub fn handle_ui_event(&mut self, event: UiEvent) {
        ...
        match &event {
            ...
            UiEvent::PointerUp(event) => {
                ...
                if event.is_primary && matches!(event.id, BosonPointerId::Finger(_)) {
        ...
        match event {
            ...
            UiEvent::PointerCancel(data) => {
                ...
                self.handle_pointer_event(
                    ...
                    None::<fn(BosonPointerEvent) -> DomEventData>,
    ...
    fn handle_pointer_event(
        &mut self,
        target: NodeId,
        data: BosonPointerEvent,
        make_ptr_data: impl FnOnce(BosonPointerEvent) -> DomEventData,
        make_mouse_data: Option<impl FnOnce(BosonPointerEvent) -> DomEventData>,
        make_touch_data: impl FnOnce(BosonPointerEvent) -> DomEventData,
    ) {
