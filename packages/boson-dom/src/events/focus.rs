use boson_traits::events::{BosonFocusEvent, DomEvent, DomEventData};
...
pub(crate) fn generate_focus_events(
    ...
    if let Some(old_focus) = old_focus {
        dispatch_event(DomEvent::new(
            old_focus,
            DomEventData::Blur(BosonFocusEvent),
        ));
        dispatch_event(DomEvent::new(
            old_focus,
            DomEventData::FocusOut(BosonFocusEvent),
        ));
    }
    ...
    if let Some(new_focus) = new_focus {
        dispatch_event(DomEvent::new(
            new_focus,
            DomEventData::Focus(BosonFocusEvent),
        ));
        dispatch_event(DomEvent::new(
            new_focus,
            DomEventData::FocusIn(BosonFocusEvent),
        ));
    }
}
