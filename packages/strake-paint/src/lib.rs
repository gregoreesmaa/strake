//! Paint a [`strake_dom::BaseDocument`] by pushing [`anyrender`] drawing commands into
...
/// Paint a [`strake_dom::BaseDocument`] by pushing drawing commands into
/// an impl [`anyrender::PaintScene`].
///
...
pub fn paint_scene(
    ...
    let generator = StrakeDomPainter::new(
        doc,
        scale,
        width,
        height,
...
fn process_custom_widget_node(
    ...
    use strake_dom::node::{CustomWidgetStatus, ProxyRenderContext};
